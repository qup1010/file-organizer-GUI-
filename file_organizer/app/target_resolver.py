...
from file_organizer.app.models import OrganizerSession, PlacementPayload

if TYPE_CHECKING:
    from file_organizer.app.session_service import OrganizerSessionService
    from file_organizer.organize.models import FinalPlan, PendingPlan
    from file_organizer.domain.models import TargetSlot
