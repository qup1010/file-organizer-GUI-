...
export function StrategySummaryChips({ strategy }: { strategy: SessionStrategySummary }) {
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <span className="ui-pill">{strategy.language_label}</span>
      <span className="ui-pill">{strategy.density_label}</span>
      <span className="ui-pill">{strategy.prefix_style_label}</span>
